...
graph_id_min = int(items_df['graph_id'].min())
graph_id_max = int(items_df['graph_id'].max())
...
for graph in graphs:
    ...
    m = bp.create_3d_model(items, connections, containers, model_name=model_name, pandas_log=True)
